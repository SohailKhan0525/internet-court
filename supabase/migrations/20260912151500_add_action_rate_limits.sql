...
create index if not exists action_rate_limits_cleanup_idx on private.action_rate_limits (window_started_at);
...
revoke execute on function public.check_action_rate_limit(uuid, text, integer, integer) from public, anon;
